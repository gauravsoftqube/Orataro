    ...
    [Utility PostApiCall:strURL params:param block:^(NSMutableDictionary *dicResponce, NSError *error)
     {
         ...
         if(!error)
         {
             ...
             if([arrResponce count] != 0)
             {
                 ...
                 {
                     UIAlertView *alrt = [[UIAlertView alloc]initWithTitle:nil message:STUDENTLIST delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                     [alrt show];
                 }
                 else
                 {
    ...
    [Utility PostApiCall:strURL params:param block:^(NSMutableDictionary *dicResponce, NSError *error)
     {
         ...
         if(!error)
         {
             ...
             if([arrResponce count] != 0)
             {
                 ...
                 if([strStatus isEqualToString:@"No Data Found"])
                 {
                     UIAlertView *alrt = [[UIAlertView alloc]initWithTitle:nil message:TEACHERLIST delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                     [alrt show];
                 }
                 else
                 {
