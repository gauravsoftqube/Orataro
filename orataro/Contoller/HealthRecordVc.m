         ...
         if(!error)
         {
             ...
             if([arrResponce count] != 0)
             {
                 ...
                 else
                 {
                     ...
                     UIAlertView *alrt = [[UIAlertView alloc]initWithTitle:nil message:HEALTHRECORD delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                     [alrt show];
                 }
             }
             else
    ...
    [Utility PostApiCall:strURL params:param block:^(NSMutableDictionary *dicResponce, NSError *error)
     {
         ...
         if(!error)
         {
             ...
             if([arrResponce count] != 0)
             {
                 ...
                 {
                     UIAlertView *alrt = [[UIAlertView alloc]initWithTitle:nil message:HEALTHGET delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                     [alrt show];
                 }
                 else
                 {
